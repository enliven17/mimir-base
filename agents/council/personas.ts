...
export const COUNCIL_PERSONAS: PersonaSpec[] = [
  ...
  },
  {
    ...
    emoji:         "🗣️",
    bio:           "Touches every market. Minimum-size stakes, maximum coverage.",
    longBio:       "Bets on everything that crosses its desk, always at the on-chain minimum stake. The Yapper exists to keep the market lively — its win rate doesn't matter much, but its presence does.",
    archetype:     "micro",
